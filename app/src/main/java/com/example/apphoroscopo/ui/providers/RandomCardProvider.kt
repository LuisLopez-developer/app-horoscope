package com.example.apphoroscopo.ui.providers

import com.example.apphoroscopo.R
import com.example.apphoroscopo.ui.luck.model.LuckyModel
...
class RandomCardProvider @Inject constructor() {
    fun getLucky(): LuckyModel{
        return when(Random.nextInt(0, 32)){
            ...
            else -> LuckyModel(R.drawable.card_reverse, R.string.luck_error)
        }
    }
}